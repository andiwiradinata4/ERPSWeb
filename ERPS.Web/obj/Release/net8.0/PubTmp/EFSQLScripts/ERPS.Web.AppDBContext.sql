...
IF NOT EXISTS (
    ...
    WHERE [MigrationId] = N'20240617072604_First Migrate'
)
BEGIN
...
BEGIN
    ...
    VALUES (N''53d635bf-0f1c-448e-8bc5-4e1a5f8a9cbe'', NULL, N''Admin'', N''ADMIN''),
    (N''b113ee5f-22fa-4e46-9225-edbc0eb2b460'', NULL, N''User'', N''USER'')');
    IF EXISTS (SELECT * FROM [sys].[identity_columns] WHERE [name] IN (N'Id', N'ConcurrencyStamp', N'Name', N'NormalizedName') AND [object_id] = OBJECT_ID(N'[dbo].[AspNetRoles]'))
...
BEGIN
    ...
    VALUES (N'20240617072604_First Migrate', N'8.0.6');
END;
GO
